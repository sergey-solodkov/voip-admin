...
/**
 * REST controller for managing {@link com.github.sergeisolodkov.voipadmin.domain.Owner}.
 */
@RestController
...
public class OwnerResource {
    ...
    public ResponseEntity<List<OwnerDTO>> getAllOwners(
        ...
        Page<OwnerDTO> page;
        if (eagerload) {
            page = ownerService.findAllWithEagerRelationships(pageable);
        } else {
            page = ownerService.findAll(pageable);
        }
