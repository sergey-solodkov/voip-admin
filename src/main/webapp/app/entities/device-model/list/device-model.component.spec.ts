...
import { sampleWithRequiredData } from '../device-model.test-samples';
...
describe('DeviceModel Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to deviceModelService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDeviceModelIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDeviceModelIdentifier).toHaveBeenCalledWith(entity);
