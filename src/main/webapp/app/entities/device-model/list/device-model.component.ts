...
import { DeviceModelService, EntityArrayResponseType } from '../service/device-model.service';
...
export class DeviceModelComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDeviceModel): number => this.deviceModelService.getDeviceModelIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.deviceModels = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDeviceModel[] | null): IDeviceModel[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.deviceModelService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
