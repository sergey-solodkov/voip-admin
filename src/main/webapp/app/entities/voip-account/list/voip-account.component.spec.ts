...
import { sampleWithRequiredData } from '../voip-account.test-samples';
...
describe('VoipAccount Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.voipAccounts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to voipAccountService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVoipAccountIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getVoipAccountIdentifier).toHaveBeenCalledWith(entity);
