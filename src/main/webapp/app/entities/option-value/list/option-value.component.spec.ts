...
import { sampleWithRequiredData } from '../option-value.test-samples';
...
describe('OptionValue Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.optionValues?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to optionValueService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOptionValueIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOptionValueIdentifier).toHaveBeenCalledWith(entity);
